...
describe('FormConstructorComponent', () => {
    ...
    let val = 'OOO';
    fakeData.subscribe((vl) => {this.val = vl; });

    const fakeModelService = {...jasmine.createSpyObj('fakeModelService',
            ['get_access', 'get_user_id', 'get_api_url', 'get_app_name', 'loadById']), entity: new SitebillEntity()};
